...
def test_no_value_assigned():
    ...
    try:
        ...
        assert (
            error.msg
            == 'Invalid syntax on line 1: "this" - bad section descriptor or value assignment'
        )
...
def test_section_with_spaces():
    ...
    try:
        ...
        assert (
            error.msg
            == 'Invalid syntax on line 3: "[this is a section]" - bad section descriptor or value assignment'
        )
